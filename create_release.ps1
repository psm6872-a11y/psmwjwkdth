...
$body = '{"tag_name":"' + $tag + '","name":"' + $tag + '","body":"v1.0.80: Revert custom keyboard, restore default system keyboard for inputs, and set number keyboard type for phone field.","draft":false,"prerelease":false}'
