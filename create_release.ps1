...
$body = '{"tag_name":"' + $tag + '","name":"' + $tag + '","body":"v1.0.74: Add clean recent call detail dialog popup upon tapping recent call log list item, with formatted name, number, date details.","draft":false,"prerelease":false}'
