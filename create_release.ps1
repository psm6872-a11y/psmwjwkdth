...
$body = '{"tag_name":"' + $tag + '","name":"' + $tag + '","body":"v1.0.36: Fix HTTP 411 Length Required error on key-value updates by configuring setFixedLengthStreamingMode(0).","draft":false,"prerelease":false}'
