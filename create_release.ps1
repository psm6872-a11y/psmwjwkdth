...
$body = '{"tag_name":"' + $tag + '","name":"' + $tag + '","body":"v1.3.11: Remove spaces from room names and prevent duplicate estimate submissions in Step 4","draft":false,"prerelease":false}'
