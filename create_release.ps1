...
$body = '{"tag_name":"' + $tag + '","name":"' + $tag + '","body":"v1.0.44: Fix infinite loading issue on room creation/join by wrapping Firestore operations in coroutines with try-catch-finally blocks.","draft":false,"prerelease":false}'
