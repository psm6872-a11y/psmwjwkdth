...
$body = '{"tag_name":"' + $tag + '","name":"' + $tag + '","body":"v1.0.41: Fallback to virtual login when real Developer Client IDs are not configured or real login fails.","draft":false,"prerelease":false}'
