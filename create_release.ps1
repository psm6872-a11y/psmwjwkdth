...
$body = '{"tag_name":"' + $tag + '","name":"' + $tag + '","body":"v1.0.34: Fixed calendar sharing connectivity issues by implementing URL-safe Base64 encoding.","draft":false,"prerelease":false}'
