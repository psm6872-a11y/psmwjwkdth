...
$body = '{"tag_name":"' + $tag + '","name":"' + $tag + '","body":"v1.0.81: Fix update error Toast loop by adding network connectivity check and throwing IOException on HTTP error response.","draft":false,"prerelease":false}'
